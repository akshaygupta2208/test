...
public class PeoplewareServiceImpl implements PeoplewareService {
    ...
    public BaseResponse qualifiedCandidates(JobOfferDTO jobOfferDTO) {
        ...
        try {
            ...
            Map<String, Integer> jobOfferSkillsMap = new HashMap<String, Integer>();
            for (JobOfferTechnicalSkill jobOfferSkills : jobOfferDetail.getJobTechnicalSkills()) {
                jobOfferSkillsMap.put(jobOfferSkills.getJobOfferSkill().getName(), jobOfferSkills.getRating());
            }
            ...
            for (Candidate candidate : candidateList) {
                ...
                for (CandidateTechnicalSkill it : candidate.getCandidateTechnicalSkills()) {
                    if (jobOfferSkillsMap.containsKey(it.getTechnicalSkill().getName())) {
                        score += it.getRating();
                    }
                }
